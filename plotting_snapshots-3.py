# Need to make sure that we are in the exact working directory that holds all the results. Eg would need to be inside Results1a
...
Rayleigh = Ra
results_direc = "Results3h"
direc = "raw_data2/"
save_direc = os.path.join(results_direc, "figs2/")
...
with h5py.File(results_direc + "/" + direc + "run_parameters/run_parameters_s1/run_parameters_s1_p0.h5", mode='r') as file:
...
'''
This is the code that Matt gave us unedited. 
